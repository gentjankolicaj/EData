...
@Component
public class PowerTemperatureMapper implements NasaCustomMapper<PowerTemperature, PowerTemperatureDTO, PowerTemperatureCmd> {
    ...
    public PowerTemperatureDTO sourceToDto(PowerTemperature source) {
        if (source == null) {
            ...
            powerTemperatureDTO.setTemperatureUnitDTO(temperatureUnitMapper.sourceToDto(source.getTemperatureUnit()));
    ...
    public PowerTemperatureCmd sourceToCommand(PowerTemperature source) {
        if (source == null) {
            ...
            powerTemperatureCmd.setTemperatureUnitCmd(temperatureUnitMapper.sourceToCommand(source.getTemperatureUnit()));
    ...
    public PowerTemperature dtoToSource(PowerTemperatureDTO dto) {
        if (dto == null) {
            ...
            powerTemperature.setTemperatureUnit(temperatureUnitMapper.dtoToSource(dto.getTemperatureUnitDTO()));
    ...
    public PowerTemperature commandToSource(PowerTemperatureCmd command) {
        if (command == null) {
            ...
            powerTemperature.setTemperatureUnit(temperatureUnitMapper.commandToSource(command.getTemperatureUnitCmd()));
