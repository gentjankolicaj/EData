...
@Component
public class PowerPressureMapper implements NasaCustomMapper<PowerPressure, PowerPressureDTO, PowerPressureCmd> {
    ...
    public PowerPressureCmd sourceToCommand(PowerPressure source) {
        if (source == null) {
            ...
            powerPressureCmd.setPressureUnitCmd(pressureUnitMapper.sourceToCommand(source.getPressureUnit()));
    ...
    public PowerPressure commandToSource(PowerPressureCmd command) {
        if (command == null) {
            ...
            powerPressure.setPressureUnit(pressureUnitMapper.commandToSource(command.getPressureUnitCmd()));
