package io.gentjankolicaj.data.load.api.v1.advice;


import io.gentjankolicaj.data.load.exception.api.request.UserBadRequestException;
import io.gentjankolicaj.data.load.exception.api.uri.UserBadUriException;
