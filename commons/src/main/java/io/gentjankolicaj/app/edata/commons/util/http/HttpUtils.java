...
import io.gentjankolicaj.app.edata.commons.util.JsonUtils;
...
public class HttpUtils {
    ...
    public static <T> T get(String uri, Object body, Class<T> clazz) throws IOException, ParseException {
        return get(uri, new HttpQueryParams(null), null, new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T get(String uri, Map<String, Object> queryParams, Map<String, Object> headers, Object body, Class<T> clazz) throws IOException, ParseException {
        return get(uri, new HttpQueryParams(queryParams), new HttpHeaders(headers), new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T get(String uri, HttpQueryParams httpQueryParams, HttpHeaders httpHeaders, HttpBody httpBody, Class<T> clazz) throws IOException, ParseException {
        ...
        try (CloseableHttpClient httpClient = HttpClientBuilder.create().build()) {
            String customUri = nonNull(httpQueryParams) ? uri + buildQueryParams(MapUtils.emptyIfNull(httpQueryParams.getPairs())) : uri;
    ...
    public static <T> T post(String uri, Object body, Class<T> clazz) throws IOException, ParseException {
        return post(uri, new HttpQueryParams(null), null, new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T post(String uri, Map<String, Object> queryParams, Map<String, Object> headers, Object body, Class<T> clazz) throws IOException, ParseException {
        return post(uri, new HttpQueryParams(queryParams), new HttpHeaders(headers), new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T post(String uri, HttpQueryParams httpQueryParams, HttpHeaders httpHeaders, HttpBody httpBody, Class<T> clazz) throws IOException, ParseException {
        if (StringUtils.isEmpty(uri)) {
            throw new IllegalArgumentException("Uri can't be null or empty.");
        }
    ...
    public static <T> T put(String uri, Object body, Class<T> clazz) throws IOException, ParseException {
        return put(uri, new HttpQueryParams(null), null, new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T put(String uri, Map<String, Object> queryParams, Map<String, Object> headers, Object body, Class<T> clazz) throws IOException, ParseException {
        return put(uri, new HttpQueryParams(queryParams), new HttpHeaders(headers), new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T put(String uri, HttpQueryParams httpQueryParams, HttpHeaders httpHeaders, HttpBody httpBody, Class<T> clazz) throws IOException, ParseException {
        if (StringUtils.isEmpty(uri)) {
            throw new IllegalArgumentException("Uri can't be null or empty.");
        }
    ...
    public static <T> T delete(String uri, Object body, Class<T> clazz) throws IOException, ParseException {
        return delete(uri, new HttpQueryParams(null), null, new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T delete(String uri, Map<String, Object> queryParams, Map<String, Object> headers, Object body, Class<T> clazz) throws IOException, ParseException {
        return delete(uri, new HttpQueryParams(queryParams), new HttpHeaders(headers), new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T delete(String uri, HttpQueryParams httpQueryParams, HttpHeaders httpHeaders, HttpBody httpBody, Class<T> clazz) throws IOException, ParseException {
        if (StringUtils.isEmpty(uri)) {
            throw new IllegalArgumentException("Uri can't be null or empty.");
        }
    ...
    public static <T> T options(String uri, Object body, Class<T> clazz) throws IOException, ParseException {
        return options(uri, new HttpQueryParams(null), null, new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T options(String uri, Map<String, Object> queryParams, Map<String, Object> headers, Object body, Class<T> clazz) throws IOException, ParseException {
        return options(uri, new HttpQueryParams(queryParams), new HttpHeaders(headers), new HttpBody(HttpBodyType.JSON, body), clazz);
    }

    public static <T> T options(String uri, HttpQueryParams httpQueryParams, HttpHeaders httpHeaders, HttpBody httpBody, Class<T> clazz) throws IOException, ParseException {
        if (StringUtils.isEmpty(uri)) {
            throw new IllegalArgumentException("Uri can't be null or empty.");
        }
    ...
    private static HttpEntity buildHttpEntity(HttpBody httpBody) {
        if (httpBody.getType().equals(HttpBodyType.TEXT)) {
            ...
            return new StringEntity(JsonUtils.writeValueAsString(httpBody.getData()), ContentType.APPLICATION_JSON);
        } else if (httpBody.getType().equals(HttpBodyType.FILE) || httpBody.getType().equals(HttpBodyType.BINARY)) {
