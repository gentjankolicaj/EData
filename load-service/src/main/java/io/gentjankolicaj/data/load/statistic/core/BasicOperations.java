...
import io.gentjankolicaj.data.load.statistic.core.exception.AttributeException;
import io.gentjankolicaj.data.load.statistic.core.exception.ItemException;
...
public class BasicOperations {
    ...
    private static Float globalMinThreshold = Float.MIN_VALUE;
    private static Float globalMaxThreshold = Float.MAX_VALUE;
